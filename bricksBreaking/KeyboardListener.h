...
namespace Keyboard {
	...
	public:
		/**
			...
			@param obs The observer to which KeyPressedEvents will be reported.
		*/
		...
		*/
		...
		/**
			...
			@param cont a Controllable object
			@param vec a vector with all the keys that are operating this object
		*/
