...
public:
	...
	*/
	bool init();
	/**
		Returns an image texture for the desired image. 

		@return An image texture for the desired image
	*/
	ImageTexture* getTexture(std::string path);
	/**
		Returns the SDL_Renderer of this graphics.

		@return The SDL_Renderer of this graphics.
	*/
